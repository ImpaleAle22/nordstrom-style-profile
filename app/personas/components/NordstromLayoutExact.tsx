/**
 * Nordstrom Layout - EXACT HTML copy from original
 */

import { CustomerProfile } from '@/lib/types';

interface NordstromLayoutExactProps {
  profile: CustomerProfile;
  children: React.ReactNode;
}

export default function NordstromLayoutExact({ profile, children }: NordstromLayoutExactProps) {
  return (
      ...
      <header className="site-header">
        ...
        <div className="site-actions">
          <a href="#" className="site-action">
            ...
            <span className="site-action-text">{profile.customer_name}</span>
          </a>
        ...
        <aside className="account-sidebar">
          <div className="account-header">
            <h2 className="account-header-title">
              ...
              <span>{profile.customer_name}'s Account</span>
            </h2>
          </div>
          ...
          <a href="#" className="account-nav-item">
            ...
            <div className="account-nav-content">
              ...
              <span className="account-nav-subtitle">$9.91 available towards...</span>
            </div>
          </a>
          ...
          <a href="#" className="account-nav-item">
            ...
            <div className="account-nav-content">
              ...
              <span className="account-nav-subtitle">Password, email, mobile & more</span>
            </div>
          </a>
          ...
          <a href="#" className="account-nav-item">
            ...
            <div className="account-nav-content">
              ...
              <span className="account-nav-subtitle">Email & mail preferences</span>
            </div>
          </a>

          <a href="#" className="account-nav-item">
            <svg className="account-nav-icon" viewBox="0 0 24 24" fill="none">
              <path fillRule="evenodd" clipRule="evenodd" d="M12 5C9.79086 5 8 6.79086 8 9C8 11.2091 9.79086 13 12 13C14.2091 13 16 11.2091 16 9C16 6.79086 14.2091 5 12 5ZM10 9C10 7.89543 10.8954 7 12 7C13.1046 7 14 7.89543 14 9C14 10.1046 13.1046 11 12 11C10.8954 11 10 10.1046 10 9Z" fill="currentColor"/>
              <path fillRule="evenodd" clipRule="evenodd" d="M12 0C7.02944 0 3 4.02944 3 9C3 10.9547 3.6243 12.7665 4.68422 14.2431L10.3583 22.3927C11.1541 23.5357 12.8452 23.5357 13.641 22.3928L19.3059 14.2569C20.3718 12.7778 21 10.9608 21 9C21 4.02944 16.9706 0 12 0ZM5 9C5 5.13401 8.13401 2 12 2C15.866 2 19 5.13401 19 9C19 10.5298 18.5104 11.9422 17.6793 13.0932L17.6693 13.1072L11.9997 21.2499L6.32134 13.0943L6.31253 13.0818C5.48634 11.9329 5 10.5247 5 9Z" fill="currentColor"/>
            </svg>
            <div className="account-nav-content">
              <span className="account-nav-title">Your Store</span>
              <span className="account-nav-subtitle">Nordstrom Michigan Avenue</span>
            </div>
          </a>
